...
const DERIVED_LEGEND = [
  ...
  '  tonightNeed and tonightNeedReason — quote the reason verbatim when you give tonight\'s number, it carries the hedges.',
  ...
  '  suggestedKcal/suggestedDelta = the weekly check. pOutside is a decision gate, NOT evidence to quote: 0.5 is its',
  '  no-information point, and it drifts toward 0.5 as the scale gets noisier. Never state it as a chance the user is',
  '  off track unless pOutsideComparable is true; otherwise talk about the rate and its interval instead.',
