    ...
    >
      ...
      <UL
        items={[
          ...
          `Pay-now purchases (for example after a demo call): the plan (and, on monthly plans, the optional done-for-you setup fee) is charged at purchase and is covered by the ${MONEY_BACK_DAYS}-day money-back guarantee in Section 7. On monthly plans, the month you paid for begins on the day carriers verify your number and your renewal date moves accordingly, so you are not billed for the days spent waiting on carrier verification; on annual plans the annual term starts on the verification date.`,
      ...
      <P>
        These Terms apply while you have an account. You may cancel your subscription at any time from the customer portal, and ask us to delete your account and data by email as described on the Data Deletion page. We may terminate for material breach that is not cured within 10 days of notice, or immediately for the conduct described in Sections 4 and 10. On termination, texting stops, forwarding should be disabled by you with your carrier, and your data is handled as described in the Privacy Policy and the{" "}
